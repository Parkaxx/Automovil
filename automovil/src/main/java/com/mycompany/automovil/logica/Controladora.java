...
//Controladora crea el objeto y se lo pasa a ControladoraPersistencia donde se guarda en la base de datos
    ...
    public void modificarAuto(Automovil auto, String modelo, String marca, String color, String patente, int cantPuertas) {
