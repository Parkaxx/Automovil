...
//Instanciamos el controlador para pedir y traer datos
    ...
    private void initComponents() {
        ...
        btnActualizar.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnEliminar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (tablaAutos.getRowCount() > 0) {
            //validar que se haya seleccionado el registro
            if (tablaAutos.getSelectedRow() != -1) {
                //obtener la id del auto que quiero borrar
                int idAuto = Integer.parseInt(String.valueOf(tablaAutos.getValueAt(tablaAutos.getSelectedRow(), 0)));
                //Todos los datos de la tabla son de tipo objeto, asi que siempre hay que hacer la conversion

                //Creamos el metodo borrarAuto
                control.borrarAuto(idAuto);
                mostrarMensaje("Auto Borrado Correctamente", "Info", "Borrado Exitoso");
                //Una vez borrado, actualizamos la tabla
                cargarTabla();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (tablaAutos.getRowCount() > 0) {
            ...
            if (tablaAutos.getSelectedRow() != -1) {
                ...
                int idAuto = Integer.parseInt(String.valueOf(tablaAutos.getValueAt(tablaAutos.getSelectedRow(), 0)));
                //Instanciamos la nueva IGU 
                ModificarAuto modif = new ModificarAuto(idAuto);
                modif.setVisible(true);
                modif.setLocationRelativeTo(null);
                
                //Comando para cerrar la ventana automaticamente
                this.dispose();
    ...
    private void cargarTabla() {
        ...
        DefaultTableModel modeloTabla = new DefaultTableModel() {
            //Sin importar la fila o columna seleccionada, no se va a poder editar
            @Override
        ...
        if (listaAutomoviles != null) {
            ...
            for (Iterator<Automovil> it = listaAutomoviles.iterator(); it.hasNext();) {
        ...
        //Le pasamos el modelo de columna a la tabla
